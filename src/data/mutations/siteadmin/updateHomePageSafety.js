...
const updateHomePageSafety = {
    ...
    args: {
        ...
        safetyGridImage4: { type: StringType }
    },
    ...
    async resolve({ request }, {
        ...
        if (request.user && request.user.admin == true) {
            ...
            const updatesafetyGridImage4 = await HomePage.update({ value: safetyGridImage4 }, { where: { name: 'safetyGridImage4' } })
                .then(function (instance) {
                    if (instance > 0) {
                        isSafetyGridUpdated = true;
                    } else {
            ...
            await TempImages.update({
                ...
                where: {
                    tableName: 'Homepage',
                    fieldName: { or: ['safetyGridImage1', 'safetyGridImage2', 'safetyGridImage3', 'safetyGridImage4'] }
                }
            });

            return {
                status: isSafetyGridUpdated ? 200 : 400
            }
