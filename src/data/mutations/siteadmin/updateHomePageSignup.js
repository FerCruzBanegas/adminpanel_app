...
const updateHomePageSignup = {
    ...
    args: {
        ...
        signupGridImage4: { type: StringType }
    },
    ...
    async resolve({ request }, {
        ...
        if (request.user && request.user.admin == true) {
            ...
            const updateSignupGridImage4 = await HomePage.update({ value: signupGridImage4 }, { where: { name: 'signupGridImage4' } })
                .then(function (instance) {
                    if (instance > 0) {
                        isSignupPageUpdated = true;
                    } else {
            ...
            await TempImages.update({
                ...
                where: {
                    tableName: 'Homepage',
                    fieldName: { or: ['signupGridImage1', 'signupGridImage2', 'signupGridImage3', 'signupGridImage4'] }
                }
            });

            return {
                status: isSignupPageUpdated ? 200 : 400
            }
