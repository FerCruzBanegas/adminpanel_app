...
let dir = '.' + homePageCategoryBannerUploadDir

const deleteHomePageCategoryBanner = app => {

	// CronJob(seconds minutes hours day-of-month months day-of-week)

	new CronJob('0 0 */6 * * *', async function () {

		console.log('holy moly remove homepage category banner requests...');
		try {
			...
			console.log('remove homepage category banner cron error: ', error);
		}
...
export default deleteHomePageCategoryBanner;