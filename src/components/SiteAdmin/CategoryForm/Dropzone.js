...
export class Dropzone extends Component {
    ...
    async success(file, fromServer) {
        ...
        let fileName = fromServer.fileName, tempName = '';
        await change("CategoryForm", fieldName, fileName);
        if (fieldName && fieldName.toString().endsWith('logo')) tempName = 'logo';
        if (fieldName && fieldName.toString().endsWith('banner')) tempName = 'banner';
        if (tempName) await updateTempImages('HomePageCategory', tempName, fileName);
    }
    ...
    render() {
        const { defaultMessage, className, subTextClass, subText, inputContainer, inputContainerClass, postUrl } = this.props;
