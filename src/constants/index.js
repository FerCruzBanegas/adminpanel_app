...
// Add Currency
export const ADD_CURRENCY_START = 'ADD_CURRENCY_START';
export const ADD_CURRENCY_SUCCESS = 'ADD_CURRENCY_SUCCESS';
export const ADD_CURRENCY_ERROR = 'ADD_CURRENCY_ERROR';

//Identity upload
export const IDENTITY_IMAGE_UPLOAD_START = 'IDENTITY_IMAGE_UPLOAD_START';
export const IDENTITY_IMAGE_UPLOAD_SUCCESS = 'IDENTITY_IMAGE_UPLOAD_SUCCESS';
export const IDENTITY_IMAGE_UPLOAD_ERROR = 'IDENTITY_IMAGE_UPLOAD_ERROR';
...
//Experience upload
export const EXPERIENCE_IMAGE_UPLOAD_START = 'EXPERIENCE_IMAGE_UPLOAD_START';
export const EXPERIENCE_IMAGE_UPLOAD_SUCCESS = 'EXPERIENCE_IMAGE_UPLOAD_SUCCESS';
export const EXPERIENCE_IMAGE_UPLOAD_ERROR = 'EXPERIENCE_IMAGE_UPLOAD_ERROR';
...
// UPDATE SMS Method 
export const UPDATE_SMS_START = 'UPDATE_SMS_START';
